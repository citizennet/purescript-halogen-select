...
(function(exports) {
  ...
  var padPrev = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Component.Calendar.Utils line 61, column 1 - line 61, column 29: " + [ v.constructor.name ]);
  };
  var padNext = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Component.Calendar.Utils line 74, column 1 - line 74, column 29: " + [ v.constructor.name ]);
  };
      ...
      var go = function (start) {
          return function (end) {
              return function (acc) {
                  ...
                  throw new Error("Failed pattern match at Example.Component.Calendar.Utils line 100, column 5 - line 103, column 60: " + [ start.constructor.name, end.constructor.name, acc.constructor.name ]);
              };
          };
      };
      return function (s) {
...
})(PS["Example.Component.Calendar.Utils"] = PS["Example.Component.Calendar.Utils"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Data_Eq = PS["Data.Eq"];
...
(function(exports) {
  ...
  var Data_Tuple = PS["Data.Tuple"];
  var Data_Unit = PS["Data.Unit"];
  var Example_Component_Calendar_Utils = PS["Example.Component.Calendar.Utils"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_HTML = PS["Halogen.HTML"];
  ...
  var generateCalendarRows = function (y) {
      return function (m) {
          var v = Example_Component_Calendar_Utils.alignByWeek(y)(m);
  ...
  var component = (function () {
      var render = function (st) {
          ...
          var renderContainer = function (y) {
              return function (m) {
                  return function (cst) {
                      var renderItem = function (index) {
                          return function (item) {
                              var printDay = function (v) {
                                  var printDay$prime = function ($81) {
                                      return Data_Either.either(Data_Function["const"]("-"))(Control_Category.id(Control_Category.categoryFn))(Data_Formatter_DateTime.formatDateTime("D")(Data_DateTime_Instant.toDateTime(Data_DateTime_Instant.fromDate($81))));
                                  };
                              ...
                              return Halogen_HTML_Elements.div(attachItemProps(index)(item)([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("w3 pa3" + (function () {
                                  var $47 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(cst.highlightedIndex)(new Data_Maybe.Just(index));
                                  if ($47) {
                      ...
                      var fmtMonthYear = function ($82) {
                          return Data_Either.either(Data_Function["const"]("-"))(Control_Category.id(Control_Category.categoryFn))(Data_Formatter_DateTime.formatDateTime("MMMM YYYY")(Data_DateTime_Instant.toDateTime(Data_DateTime_Instant.fromDate($82))));
                      };
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mw8 sans-serif center") ])([ renderToggle, Halogen_HTML.slot(Data_Unit.unit)(Select_Primitives_Container.component(Control_Monad_Aff_Class.monadAffAff))({
      ...
      var initialState = Data_Function["const"]({
          targetDate: new Data_Tuple.Tuple(Example_Component_Calendar_Utils.unsafeMkYear(2019), Example_Component_Calendar_Utils.unsafeMkMonth(2))
      });
      var $$eval = function (v) {
          ...
          if (v instanceof HandleContainer) {
              ...
              if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                      ...
                      return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.log("Selected! Choice was " + showCalendar(v.value0.value0)));
                  })());
              };
              throw new Error("Failed pattern match at Example.Component.Calendar line 80, column 30 - line 85, column 73: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof ToggleMonth) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  var newDate = (function () {
                      if (v.value0 instanceof Next) {
                          return Example_Component_Calendar_Utils.nextMonth(Data_Date.canonicalDate(y)(m)(Data_Bounded.bottom(Data_Date_Component.boundedDay)));
                      };
                      if (v.value0 instanceof Prev) {
                          return Example_Component_Calendar_Utils.prevMonth(Data_Date.canonicalDate(y)(m)(Data_Bounded.bottom(Data_Date_Component.boundedDay)));
                      };
                      throw new Error("Failed pattern match at Example.Component.Calendar line 93, column 23 - line 95, column 60: " + [ v.value0.constructor.name ]);
                  })();
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $64.targetDate = new Data_Tuple.Tuple(Data_Date.year(newDate), Data_Date.month(newDate));
                      return $64;
                  });
              }));
          };
          if (v instanceof ToggleYear) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  var newDate = (function () {
                      if (v.value0 instanceof Next) {
                          return Example_Component_Calendar_Utils.nextYear(Data_Date.canonicalDate(y)(m)(Data_Bounded.bottom(Data_Date_Component.boundedDay)));
                      };
                      if (v.value0 instanceof Prev) {
                          return Example_Component_Calendar_Utils.prevYear(Data_Date.canonicalDate(y)(m)(Data_Bounded.bottom(Data_Date_Component.boundedDay)));
                      };
                      throw new Error("Failed pattern match at Example.Component.Calendar line 105, column 23 - line 107, column 59: " + [ v.value0.constructor.name ]);
                  })();
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $71 = {};
                      for (var $72 in v2) {
                      ...
                      $71.targetDate = new Data_Tuple.Tuple(Data_Date.year(newDate), Data_Date.month(newDate));
                      return $71;
                  });
              }));
          };
          if (v instanceof SetTime) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Now.now))(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $77.targetDate = new Data_Tuple.Tuple(Data_Date.year(d), Data_Date.month(d));
                      return $77;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          throw new Error("Failed pattern match at Example.Component.Calendar line 77, column 12 - line 115, column 16: " + [ v.constructor.name ]);
      };
...
})(PS["Example.Component.Calendar"] = PS["Example.Component.Calendar"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CSS = PS["CSS"];
  ...
  var class_ = function ($30) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($30));
  };
      ...
      var renderItem = function (index) {
          return function (item) {
              var props = [ class_("px-4 py-1 text-grey-darkest" + (function () {
                  var $7 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(st.highlightedIndex)(new Data_Maybe.Just(index));
                  if ($7) {
  ...
  var renderSelections = function (items) {
      ...
      var $9 = Data_Array.length(items) === 0;
      if ($9) {
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof Log) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.log(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
          };
          if (v instanceof ToContainer) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(v.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
          };
          if (v instanceof HandleContainer) {
              ...
              if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.log("Selected: " + v.value0.value0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $17.selected = Data_Array.cons(v.value0.value0)(st.selected);
                          return $17;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.logShow(Data_Show.showArray(Data_Show.showString))(v1.selected)))(function () {
              ...
              throw new Error("Failed pattern match at Example.Component.Dropdown line 81, column 30 - line 95, column 17: " + [ v.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Example.Component.Dropdown line 76, column 12 - line 110, column 15: " + [ v.constructor.name ]);
      };
...
})(PS["Example.Component.Dropdown"] = PS["Example.Component.Dropdown"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var component = function (dictMonadAff) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleSearch) {
                  ...
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.log("New search performed: " + v.value0.value0)))(function () {
                          ...
                          var newItems = (function () {
                              ...
                              throw new Error("Failed pattern match at Example.Component.Typeahead line 104, column 15 - line 106, column 51: " + [  ]);
                          })();
              ...
              throw new Error("Failed pattern match at Example.Component.Typeahead line 87, column 27 - line 114, column 17: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof HandleContainer) {
              if (v.value0 instanceof Select_Primitives_Container.Emit) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)($$eval(v.value0.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              ...
              throw new Error("Failed pattern match at Example.Component.Typeahead line 117, column 30 - line 135, column 76: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof Removed) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
          ...
          throw new Error("Failed pattern match at Example.Component.Typeahead line 83, column 12 - line 148, column 74: " + [ v.constructor.name ]);
      };
  ...
  exports["renderContainer"] = renderContainer;
  exports["renderSelections"] = renderSelections;
})(PS["Example.Component.Typeahead"] = PS["Example.Component.Typeahead"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Data_Unit = PS["Data.Unit"];
  var Data_Void = PS["Data.Void"];
  var Example_Component_Calendar = PS["Example.Component.Calendar"];
  var Example_Component_Dropdown = PS["Example.Component.Dropdown"];
  var Example_Component_Typeahead = PS["Example.Component.Typeahead"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_Component_ChildPath = PS["Halogen.Component.ChildPath"];
  var Halogen_HTML = PS["Halogen.HTML"];
  ...
  var dev = [ "Thomas Honeyman", "Dave Zuch", "Chris Cornwell", "Forest Toney", "Lee Leathers", "Kim Wu", "Rachel Blair", "Tara Strauss", "Sanket Sabnis", "Aaron Chu", "Vincent Busam", "Riley Gibbs" ];
  var class_ = function ($16) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($16));
  };
  var componentBlock = function (v) {
      return Halogen_HTML_Elements.div([ class_("rounded border-2 border-grey-light bg-white") ])([ Halogen_HTML_Elements.div([ class_("p-4 bg-grey-lightest") ])([ v.slot ]), Halogen_HTML_Elements.div([ class_("p-4 border-t-2 border-grey-light") ])([ v.docs ]) ]);
  };
  var dropdownComponent = (function () {
      var docs = Halogen_HTML_Elements.p([ class_("font-mono text-grey-darkest") ])([ Halogen_HTML_Core.text("HH.slot' CP.cp1 unit Dropdown.component unit absurd") ]);
      return componentBlock({
          slot: Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Example_Component_Dropdown.component)(Data_Unit.unit)(Data_Void.absurd),
          docs: docs
      });
  })();
  var dropdown = {
  ...
  var footer = Halogen_HTML_Elements.div([ class_("bg-grey-lighter py-8 px-4") ])([ Halogen_HTML_Elements.div([ class_("container max-w-md mx-auto px-4 text-grey-darker") ])([ Halogen_HTML_Core.text("Proudly open-sourced by CitizenNet, a Conde Nast company.") ]) ]);
  var header = Halogen_HTML_Elements.div([ class_("bg-grey-lighter") ])([ Halogen_HTML_Elements.div([ class_("container max-w-md mx-auto py-16 px-4") ])([ Halogen_HTML_Elements.h1([ class_("text-6xl text-black mb-6 font-bold") ])([ Halogen_HTML_Core.text("Halogen Select") ]), Halogen_HTML_Elements.p([ class_("text-grey-darker text-xl font-medium mb-4") ])([ Halogen_HTML_Core.text("Primitive components for selection user interfaces like calendars, typeaheads, dropdowns, and image pickers.") ]) ]) ]);
  var subhead = Halogen_HTML_Elements.div([ class_("bg-grey-lightest") ])([ Halogen_HTML_Elements.div([ class_("container max-w-md mx-auto py-16 px-4") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("https://github.com/citizennet/purescript-halogen-select"), class_("text-grey-darkest hover_underline") ])([ Halogen_HTML_Core.text("Star the repo on GitHub.") ]) ]) ]);
  var typeaheadComponent = function (dictMonadAff) {
      var docs = Halogen_HTML_Elements.p([ class_("font-mono text-grey-darkest") ])([ Halogen_HTML_Core.text("HH.slot' CP.cp2 unit Typeahead.Component myData absurd") ]);
      return componentBlock({
          slot: Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Example_Component_Typeahead.component(dictMonadAff))(dev)(Halogen_HTML_Events.input(HandleTypeahead.create)),
          docs: docs
      });
  };
  var typeahead = function (dictMonadAff) {
      return {
          ...
          component: typeaheadComponent(dictMonadAff)
      };
  };
  var card = function (v) {
      return Halogen_HTML_Elements.div([ class_("mb-8") ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text(v.title) ]), Halogen_HTML_Elements.div([ class_("text-xl text-grey-dark mb-4 mt-2") ])([ Halogen_HTML_Core.text(v.description) ]), v.component ]);
  };
  var container = function (components1) {
      return Halogen_HTML_Elements.div([ class_("container max-w-md mx-auto py-16 px-4") ])(Data_Functor.map(Data_Functor.functorArray)(card)(components1));
  };
  var calendarComponent = (function () {
      var docs = Halogen_HTML_Elements.p([ class_("font-mono text-grey-darkest") ])([ Halogen_HTML_Core.text("HH.slot' CP.cp3 unit Calendar.component unit absurd") ]);
      return componentBlock({
          slot: Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Example_Component_Calendar.component)(Data_Unit.unit)(Data_Void.absurd),
          docs: docs
      });
  })();
  var calendar = {
  ...
  var components = [ dropdown, typeahead(Control_Monad_Aff_Class.monadAffAff), calendar ];
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div([ class_("leading-normal") ])([ header, subhead, container(components), footer ]);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
      };
  ...
  exports["dev"] = dev;
})(PS["Example.Content.Home"] = PS["Example.Content.Home"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Data_Unit = PS["Data.Unit"];
  var Example_Content_Home = PS["Example.Content.Home"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Example_Content_Home.component)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
