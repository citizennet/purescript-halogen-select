...
(function(exports) {
  ...
  var getVisibility = Control_Monad_Free.liftF(new GetVisibility(Control_Category.id(Control_Category.categoryFn)));
...
(function(exports) {
  ...
  var setToggleProps = Data_Function.flip(Data_Semigroup.append(Data_Semigroup.semigroupArray))([ Halogen_HTML_Events.onFocus(function (ev) {
      ...
      return new Data_Maybe.Just(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Select.captureRef(DOM_Event_Types.mouseEventToEvent(ev)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Select.preventClick(ev))(function () {
              return Control_Bind.bind(Control_Monad_Free.freeBind)(Select.getVisibility)(function (v) {
                  ...
                  throw new Error("Failed pattern match at Select.Utils.Setters line 49, column 32 - line 55, column 41: " + [ v.constructor.name ]);
              });
          });
      }));
  ...
  var component = function (dictMonadAff) {
      var render = function (st) {
          var renderDropdown = function (state) {
              var renderToggle = Halogen_HTML_Elements.button(Select_Utils_Setters.setToggleProps([ Halogen_HTML_Properties.classes(Docs_CSS.button) ]))([ Halogen_HTML_Core.text(st.text) ]);
              var renderMenu = (function () {
                  var renderItem = function (index) {
                      return function (item) {
                          ...
                          return Halogen_HTML_Elements.li(Select_Utils_Setters.setItemProps(index)(props))([ Halogen_HTML_Core.text(item) ]);
                      };
                  };
                  var renderContainer = function (html) {
                      return Halogen_HTML_Elements.div(Select_Utils_Setters.setContainerProps([ Halogen_HTML_Properties.classes(Docs_CSS.itemContainer) ]))([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes(Docs_CSS.ul) ])(html) ]);
                  };
...
(function(exports) {
  ...
  var renderInputContainer = function (state) {
      var renderInput = Halogen_HTML_Elements.input(Select_Utils_Setters.setInputProps([ Halogen_HTML_Properties.classes(Docs_CSS.input), Halogen_HTML_Properties.placeholder("Type to search...") ]));
      var renderContainer = (function () {
          ...
          var renderItems = function (html) {
              return Halogen_HTML_Elements.div(Select_Utils_Setters.setContainerProps([ class_("absolute bg-white shadow rounded-sm pin-t pin-l w-full") ]))([ renderChild, Halogen_HTML_Elements.ul([ class_("list-reset") ])(html) ]);
          };
  ...
  var component = function (dictMonadAff) {
      ...
      var $$eval = function (v) {
                  ...
                  if (v.value0 instanceof Select.Searched) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select.replaceItems(newItems)))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(function ($46) {
                                  return Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select.highlight(Select.Index.create($46)));
                              })(index))(function () {
                                  return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.log("New search: " + v.value0.value0));
                              });
                          });
                      });
                  };
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v3) {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select.replaceItems(newItems)))(function (v4) {
                                          return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.log("New item selected: " + v.value0.value0));
                                      });
                                  });
                              });
                          });
          ...
          throw new Error("Failed pattern match at Docs.Components.Typeahead line 78, column 12 - line 121, column 15: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
          initialState: initialState,
          render: render,
...
(function(exports) {
  ...
  var routes = function (dictMonadAff) {
      return Data_Map.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ Data_Tuple.Tuple.create("typeahead")(Docs_Internal_Proxy.proxy(Docs_Internal_Component.typeahead(dictMonadAff))), Data_Tuple.Tuple.create("dropdown")(Docs_Internal_Proxy.proxy(Docs_Internal_Component.dropdown(dictMonadAff))) ]);
  };
  ...
  var app = function (dictMonadAff) {
      var render = function (st) {
          ...
          throw new Error("Failed pattern match at Main line 68, column 7 - line 70, column 61: " + [ mbComponent.constructor.name ]);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
