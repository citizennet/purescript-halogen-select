          ...
          var renderDropdown = function (state) {
              ...
              var renderContainer = (function () {
                  ...
                  var renderItem = function (index) {
                      return function (item) {
                          var props = [ class_("px-4 py-1 text-grey-darkest" + (function () {
                              var $7 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(state.highlightedIndex)(new Data_Maybe.Just(index));
                              if ($7) {
                  ...
                  return Halogen_HTML_Elements.div([ class_("relative z-50") ])((function () {
                      var $8 = Data_Eq.eq(Select.eqVisibility)(state.visibility)(Select.Off.value);
                      if ($8) {
                          return [  ];
                      };
          ...
          if (v.value0 instanceof Select.Selected) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select.setVisibility(Select.Off.value)))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select.triggerBlur))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select.replaceItems(Data_Array.difference(Data_Eq.eqString)(v1.items)([ v.value0.value0 ]))))(function (v4) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                  var $11 = {};
                                  for (var $12 in v5) {
                                      if ({}.hasOwnProperty.call(v5, $12)) {
                                          $11[$12] = v5[$12];
                                      };
                                  };
                                  $11.text = v.value0.value0;
                                  return $11;
                              }))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
