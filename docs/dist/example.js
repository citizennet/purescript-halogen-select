...
(function(exports) {
  ...
  var component = (function () {
      var render = function (st) {
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mw8 sans-serif center") ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.class_("black-80 f-headline-1") ])([ Halogen_HTML_Core.text("Calendar Component") ]), renderToggle, Halogen_HTML.slot(Data_Unit.unit)(Select_Primitives_Container.component(Control_Monad_Aff_Class.monadAffAff))({
...
(function(exports) {
  ...
  var renderToggle = Halogen_HTML_Elements.span(Select_Primitives_Container.getToggleProps(ToContainer.create)([ Halogen_HTML_Events.onMouseOver(Halogen_HTML_Events.input_(Log.create("I'm the parent."))), Halogen_HTML_Properties.class_("f5 link ba bw1 ph3 pv2 mb2 dib near-black pointer outline-0") ]))([ Halogen_HTML_Core.text("Toggle") ]);
  var renderContainer = function (st) {
      var renderItems = function (html) {
          return Halogen_HTML_Elements.div(Select_Primitives_Container.getContainerProps([ Halogen_HTML_Properties.class_("measure ba br1 b--black-30 overflow-y-scroll pb3 outline-0"), Halogen_HTML_CSS.style(CSS_Geometry.maxHeight(CSS_Size.px(300.0))) ]))([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("cf") ])([ Halogen_HTML_Elements.h4([ Halogen_HTML_Properties.class_("ph2 pv3 ma0 fl w-50") ])([ Halogen_HTML_Core.text("Choose One") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("fl w-50 tr") ])([ Halogen_HTML_Elements.button(Select_Primitives_Container.getChildProps([ Halogen_HTML_Properties.class_("ma2 ba bw1 ph3 pv2 dib b--near-black pointer outline-0 link"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Select_Primitives_Container.Raise.create(Halogen_Query.action(Log.create("button in container clicked"))))) ]))([ Halogen_HTML_Core.text("Click Me") ]) ]) ]), Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list pl0 mt0 bt b--black-30") ])(html) ]);
      };
      var renderItem = function (index) {
          return function (item) {
              var item$prime = Select_Primitives_Container.getItemProps(index)([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("lh-copy pa2 ba bl-0 bt-0 br-0 b--dotted b--black-30" + (function () {
                  var $4 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(st.highlightedIndex)(new Data_Maybe.Just(index));
                  if ($4) {
                      return " bg-light-blue";
                  };
                  return "";
              })())) ]);
              return Halogen_HTML_Elements.li(item$prime)([ Halogen_HTML_Core.text(item) ]);
          };
      };
      return Halogen_HTML_Elements.div_((function () {
          var $5 = !st.open;
  ...
  var component = (function () {
      var render = function (st) {
          var selected = (function () {
              var $6 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(st.selected)([  ]);
              if ($6) {
                  return [  ];
              };
              return [ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.class_("black-80 mt5 f-headline-1") ])([ Halogen_HTML_Core.text("Selected Items") ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(function (i) {
                  return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(i) ]);
              })(st.selected)) ];
          })();
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mw8 sans-serif center") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.class_("black-80 f-headline-1"), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(function ($21) {
              return Log.create(DOM_Event_KeyboardEvent.code($21));
          })) ])([ Halogen_HTML_Core.text("Menu Component") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Open the console to view outputs. "), Halogen_HTML_Core.text("Mouse over the toggle to trigger an embedded parent query. "), Halogen_HTML_Core.text("Click the toggle to open or close the menu. Click an item to select it (and remove it from the available options).") ]), renderToggle, Halogen_HTML.slot(Data_Unit.unit)(Select_Primitives_Container.component(Control_Monad_Aff_Class.monadAffAff))({
              items: testData,
              render: renderContainer
          })(Halogen_HTML_Events.input(HandleContainer.create)) ])(selected));
      };
      var initState = {
          items: testData,
          selected: [  ]
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleContainer) {
              ...
              if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.log("Selected: " + v.value0.value0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $14.selected = Data_Array.cons(v.value0.value0)(st.selected);
                          return $14;
                      }))(function () {
              ...
              throw new Error("Failed pattern match at Example.Component.Dropdown line 78, column 30 - line 90, column 17: " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at Example.Component.Dropdown line 73, column 12 - line 90, column 17: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var renderSearch = function (st) {
      return Halogen_HTML_Elements.input(Select_Primitives_Search.getInputProps([  ]));
  };
  var renderContainer = function (st) {
      var renderItems = function (html) {
          return Halogen_HTML_Elements.div(Select_Primitives_Container.getContainerProps([ Halogen_HTML_Properties.class_("measure ba br1 b--black-30 overflow-y-scroll outline-0"), Halogen_HTML_CSS.style(CSS_Geometry.maxHeight(CSS_Size.px(300.0))) ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("cf") ])([ Halogen_HTML_Elements.h4([ Halogen_HTML_Properties.class_("ph2 pv3 ma0 fl w-50") ])([ Halogen_HTML_Core.text("Choose One") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("fl w-50 tr") ])([ Halogen_HTML_Elements.button(Select_Primitives_Container.getChildProps([ Halogen_HTML_Properties.class_("ma2 ba bw1 ph3 pv2 dib b--near-black pointer outline-0 link"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Select_Primitives_Container.Raise.create(Halogen_Query.action(Log.create("I've been clicked!"))))) ]))([ Halogen_HTML_Core.text("Click Me") ]) ]) ]) ])((function () {
              var $11 = Data_Foldable.length(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(html) > 0;
              if ($11) {
                  return [ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list pa0 ma0 bt b--black-30") ])(html) ];
              };
              return [ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("lh-copy black-70 pa2") ])([ Halogen_HTML_Core.text("No results for that search.") ]) ];
          })()));
      };
      var renderItem = function (index) {
          return function (item) {
              var item$prime = Select_Primitives_Container.getItemProps(index)([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("lh-copy pa2 bb b--black-10" + (function () {
  ...
  var component = function (dictMonadAff) {
      var render = function (st) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mw8 sans-serif center") ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.class_("black-80 f-headline-1") ])([ Halogen_HTML_Core.text("Typeahead Component") ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(function (elem) {
              return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(elem) ]);
          })(st.selected)), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Select_Primitives_Search.component(dictMonadAff))({
              render: renderSearch,
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleSearch) {
                  ...
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.log("New search performed: " + v.value0.value0)))(function () {
                          ...
                          var newItems = (function () {
                              ...
                              throw new Error("Failed pattern match at Example.Component.Typeahead line 108, column 15 - line 110, column 51: " + [  ]);
                          })();
              ...
              throw new Error("Failed pattern match at Example.Component.Typeahead line 91, column 27 - line 118, column 17: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof HandleContainer) {
              if (v.value0 instanceof Select_Primitives_Container.Emit) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)($$eval(v.value0.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              ...
              throw new Error("Failed pattern match at Example.Component.Typeahead line 121, column 30 - line 135, column 76: " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at Example.Component.Typeahead line 87, column 12 - line 135, column 76: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Example_Component_Dropdown.component)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Example_Component_Typeahead.component(Control_Monad_Aff_Class.monadAffAff))(dev)(Halogen_HTML_Events.input(HandleTypeahead.create)), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Example_Component_Calendar.component)(Data_Unit.unit)(Data_Void.absurd) ]);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
      };
