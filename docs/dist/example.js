...
(function(exports) {
  ...
  var Documentation = (function () {
      ...
      Documentation.value = new Documentation();
  ...
  var ChangeLocation = (function () {
      function ChangeLocation(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeLocation.create = function (value0) {
          return function (value1) {
              return new ChangeLocation(value0, value1);
          };
      };
      return ChangeLocation;
  })();
  var PushLocation = (function () {
      function PushLocation(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      PushLocation.create = function (value0) {
          return function (value1) {
              return new PushLocation(value0, value1);
          };
      };
      return PushLocation;
  })();
  ...
  var showLocation = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Example.Routes line 36, column 1 - line 36, column 39: " + [ v.constructor.name ]);
  });
  var router = Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Home.value)(Control_Apply.applySecond(Routing_Match.matchApply)(Control_Apply.applySecond(Routing_Match.matchApply)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)(""))(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("")))(Routing_Match_Class.end(Routing_Match.matchMatchClass))))(Data_Functor.voidRight(Routing_Match.matchFunctor)(Guide.value)(Control_Apply.applySecond(Routing_Match.matchApply)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)(""))(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("guide")))))(Data_Functor.voidRight(Routing_Match.matchFunctor)(Components.value)(Control_Apply.applySecond(Routing_Match.matchApply)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)(""))(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("components")))))(Data_Functor.voidRight(Routing_Match.matchFunctor)(Tutorials.value)(Control_Apply.applySecond(Routing_Match.matchApply)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)(""))(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("tutorials")))))(Data_Functor.voidRight(Routing_Match.matchFunctor)(Documentation.value)(Control_Apply.applySecond(Routing_Match.matchApply)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)(""))(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("docs"))));
  var pathFromLocation = function (v) {
      if (v instanceof Home) {
          return "/";
      };
      if (v instanceof Guide) {
      ...
      throw new Error("Failed pattern match at Example.Routes line 45, column 20 - line 54, column 1: " + [ v.constructor.name ]);
  };
  var locationFromPath = function ($27) {
      return Data_Either.either(function (v) {
          return NotFound.value;
      })(Control_Category.id(Control_Category.categoryFn))(Routing.match(router)($27));
  };
  var app = function (dictMonadAff) {
      return function (location) {
          var render = function (st) {
              if (st.location instanceof Home) {
                  return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("home") ]);
              };
          ...
          var $$eval = function (v) {
              if (v instanceof ChangeLocation) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $14.location = v.value0;
                      return $14;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              if (v instanceof PushLocation) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $19 = {};
                      for (var $20 in v1) {
                      ...
                      $19.location = v.value0;
                      return $19;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadAff.MonadEff0()))(function __do() {
                          var v1 = Control_Bind.bindFlipped(Control_Monad_Eff.bindEff)(DOM_HTML_Window.history)(DOM_HTML.window)();
                          return DOM_HTML_History.pushState(Data_Foreign.toForeign({}))("Select ")(DOM_HTML_History.URL(pathFromLocation(v.value0)))(v1)();
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              ...
              if (v instanceof Initialize) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.log(Data_Show.show(showLocation)(v1.location))))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
                  });
              };
              throw new Error("Failed pattern match at Example.Routes line 117, column 10 - line 137, column 12: " + [ v.constructor.name ]);
          };
          return Halogen_Component.lifecycleParentComponent(Data_Ord.ordString)({
  ...
  exports["pathFromLocation"] = pathFromLocation;
  exports["locationFromPath"] = locationFromPath;
...
})(PS["Example.Routes"] = PS["Example.Routes"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Data_Show = PS["Data.Show"];
  var Data_Unit = PS["Data.Unit"];
  var Example_Routes = PS["Example.Routes"];
  var Halogen = PS["Halogen"];
  ...
  var Prelude = PS["Prelude"];        
  var pushStateConsumer = function (dictMonad) {
      return function (dictDiscard) {
          return function (query) {
              return Control_Coroutine.consumer(dictMonad)(function (event) {
                  return Control_Bind.discard(dictDiscard)(dictMonad.Bind1())(query(Halogen_Query.action(Example_Routes.ChangeLocation.create(event))))(function () {
  ...
  var getRoute = function __do() {
      var v = Control_Bind.bindFlipped(Control_Monad_Eff.bindEff)(DOM_HTML_Window.location)(DOM_HTML.window)();
      var v1 = DOM_HTML_Location.pathname(v)();
      var v2 = DOM_HTML_Location.search(v)();
      Control_Monad_Eff_Console.log(v1 + v2)();
      Control_Monad_Eff_Console.log(Data_Show.show(Example_Routes.showLocation)(Example_Routes.locationFromPath(v1 + v2)))();
      return Example_Routes.locationFromPath(v1 + v2);
  };
  var pushStateProducer = Control_Coroutine_Aff.produce(function (emit) {
      var route = function __do() {
          var v = getRoute();
          return emit(Data_Either.Left.create(v))();
      };
      return function __do() {
          var $16 = DOM_HTML.window();
          return DOM_Event_EventTarget.addEventListener(DOM_HTML_Event_EventTypes.popstate)(DOM_Event_EventTarget.eventListener(Control_Applicative.pure(Control_Applicative.applicativeFn)(route)))(false)(DOM_HTML_Types.windowToEventTarget($16))();
      };
  });
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(getRoute))(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Example_Routes.app(Control_Monad_Aff_Class.monadAffAff)(v))(Data_Unit.unit)(v1))(function (v2) {
              return Control_Coroutine.runProcess(Control_Monad_Aff.monadRecAff)(Control_Coroutine.connect(Control_Monad_Aff.monadRecAff)(Control_Monad_Aff.parallelAff)(pushStateProducer)(pushStateConsumer(Control_Monad_Aff.monadAff)(Control_Bind.discardUnit)(v2.query)));
          });
      });
  }));
  exports["main"] = main;
  exports["getRoute"] = getRoute;
  exports["pushStateProducer"] = pushStateProducer;
  exports["pushStateConsumer"] = pushStateConsumer;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
