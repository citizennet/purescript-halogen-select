...
(function(exports) {
  ...
  var formatterCommandParser = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Data_Formatter_Parser_Utils.oneOfAs(Data_Functor.functorArray)(Data_Foldable.foldableArray)(Data_Identity.monadIdentity)(function ($506) {
      return Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)($506));
...
(function(exports) {
  ...
  var unsafeSucc = function (dictEnum) {
      return function ($27) {
          return Data_Maybe.fromJust()(Data_Enum.succ(dictEnum)($27));
      };
  };
  var unsafePred = function (dictEnum) {
      return function ($28) {
          return Data_Maybe.fromJust()(Data_Enum.pred(dictEnum)($28));
      };
  };
  var unsafeMkYear = function ($29) {
      return Data_Maybe.fromJust()(Data_Enum.toEnum(Data_Date_Component.boundedEnumYear)($29));
  };
      ...
      var go = function ($copy_v) {
          return function ($copy_acc) {
              ...
              function $tco_loop(v, acc) {
                  ...
                  $copy_acc = Data_Array.cons(Data_Array.take(7)(v))(acc);
                  return;
              };
              while (!$tco_done) {
  ...
  var padPrev = function (v) {
      ...
      throw new Error("Failed pattern match at Docs.Components.Calendar.Utils line 61, column 1 - line 61, column 29: " + [ v.constructor.name ]);
  };
  var padNext = function (v) {
      ...
      throw new Error("Failed pattern match at Docs.Components.Calendar.Utils line 74, column 1 - line 74, column 29: " + [ v.constructor.name ]);
  };
  ...
  var adjustDaysBy = function (n) {
      ...
      return function ($32) {
          return Data_Maybe.fromJust()(next(n)($32));
      };
  };
          ...
          return function (end) {
              return function (acc) {
                  if (Data_Eq.eq(Data_Date.eqDate)(start)(end)) {
                      return Data_Array.reverse(Data_Array.cons(start)(acc));
                  };
                  if (Data_Ord.greaterThan(Data_Date.ordDate)(start)(end)) {
                      return Data_Array.reverse(go(end)(start)(acc));
                  };
                  if (Data_Boolean.otherwise) {
                      return go(nextDay(start))(end)(Data_Array.cons(start)(acc));
                  };
                  throw new Error("Failed pattern match at Docs.Components.Calendar.Utils line 100, column 5 - line 103, column 60: " + [ start.constructor.name, end.constructor.name, acc.constructor.name ]);
              };
          };
      };
      return function (s) {
  ...
  var alignByWeek = function (y) {
      return function (m) {
          var start = firstDateOfMonth(y)(m);
          var pre = (function () {
              ...
              return dateRange(adjustDaysBy(pad)(start))(prevDay(start));
          })();
          var end = lastDateOfMonth(y)(m);
          var post = (function () {
              ...
              return dateRange(nextDay(end))(adjustDaysBy(pad)(end));
          })();
          var body = dateRange(start)(end);
          return {
              pre: pre,
              body: body,
              post: post,
...
})(PS["Docs.Components.Calendar.Utils"] = PS["Docs.Components.Calendar.Utils"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Data_Eq = PS["Data.Eq"];
...
(function(exports) {
  ...
  var getChildProps = Data_Function.flip(Data_Semigroup.append(Data_Semigroup.semigroupArray))([ Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_(Blur.create)), Halogen_HTML_Properties.tabIndex(0) ]);
...
(function(exports) {
  ...
  var Data_Tuple = PS["Data.Tuple"];
  var Data_Unit = PS["Data.Unit"];
  var Docs_Components_Calendar_Utils = PS["Docs.Components.Calendar.Utils"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_HTML = PS["Halogen.HTML"];
  ...
  var SetTime = (function () {
      function SetTime(value0) {
          this.value0 = value0;
      };
      SetTime.create = function (value0) {
          return new SetTime(value0);
      };
      return SetTime;
  })();
  var generateCalendarRows = function (y) {
      return function (m) {
          var v = Docs_Components_Calendar_Utils.alignByWeek(y)(m);
          var thisMonth = Data_Functor.mapFlipped(Data_Functor.functorArray)(v.body)(function (i) {
              return new CalendarItem(Selectable.value, NotSelected.value, InBounds.value, i);
          });
          var outOfBounds = Data_Functor.map(Data_Functor.functorArray)(function (i) {
              return new CalendarItem(Selectable.value, NotSelected.value, OutOfBounds.value, i);
          });
  ...
  var component = function (dictMonadAff) {
      var render = function (st) {
          ...
          var renderToggle = Halogen_HTML_Elements.span(Select_Primitives_Container.getToggleProps(ToContainer.create)([ Halogen_HTML_Properties.class_("f5 link ba bw1 ph3 pv2 mb2 dib near-black pointer outline-0") ]))([ Halogen_HTML_Core.text("Toggle") ]);
          var renderContainer = function (y) {
              return function (m) {
                  return function (cst) {
                      var renderItem = function (index) {
                          return function (item) {
                              var printDay = function (v) {
                                  var printDay$prime = function ($82) {
                                      return Data_Either.either(Data_Function["const"]("-"))(Control_Category.id(Control_Category.categoryFn))(Data_Formatter_DateTime.formatDateTime("D")(Data_DateTime_Instant.toDateTime(Data_DateTime_Instant.fromDate($82))));
                                  };
                              ...
                              var getCalendarStyles = function (i) {
                                  ...
                                  var getSelectableStyles = function (v) {
                                      if (v.value0 instanceof NotSelectable) {
                                          return "color: rgba(0,0,0,0.6); background-image: linear-gradient(to bottom, rgba(125,125,125,0.75) 0%, rgba(125,125,125,0.75), 100%;";
                                      };
                                      return Data_Monoid.mempty(Data_Monoid.monoidString);
                                  };
                                  ...
                                  return getSelectableStyles(i) + (" " + (getSelectedStyles(i) + (" " + getBoundaryStyles(i))));
                              };
                              var attachItemProps = function (v) {
                                  return function (v1) {
                                      return function (props) {
                                          if (v1.value0 instanceof Selectable) {
                                              return Select_Primitives_Container.getItemProps(v)(props);
                                          };
                                          return props;
                                      };
                                  };
                              };
                              return Halogen_HTML_Elements.div(attachItemProps(index)(item)([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("w3 pa3" + (function () {
                                  var $48 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(cst.highlightedIndex)(new Data_Maybe.Just(index));
                                  if ($48) {
                                      return " bg-washed-green";
                                  };
                                  return "";
                              })())), Halogen_HTML_Properties.attr("style")(getCalendarStyles(item)) ]))([ Halogen_HTML_Core.text(printDay(item)) ]);
                          };
                      };
                      var renderRows = (function () {
                          var renderRow = function (offset) {
                              return function (items) {
                                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("flex") ])(Data_Array.mapWithIndex(function (column) {
                                      return function (item) {
                      ...
                      var fmtMonthYear = function ($83) {
                          return Data_Either.either(Data_Function["const"]("-"))(Control_Category.id(Control_Category.categoryFn))(Data_Formatter_DateTime.formatDateTime("MMMM YYYY")(Data_DateTime_Instant.toDateTime(Data_DateTime_Instant.fromDate($83))));
                      };
                      ...
                      var calendarNav = (function () {
                          var dateHeader = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("w-60 b") ])([ Halogen_HTML_Core.text(monthYear) ]);
                          var arrowButton = function (q) {
                              return function (t) {
                                  return function (css) {
                                      return Halogen_HTML_Elements.button(Select_Primitives_Container.getChildProps([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("w-10" + Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Semigroup.append(Data_Semigroup.semigroupString)(" "))(css)))), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Select_Primitives_Container.Raise.create(Halogen_Query.action(q)))) ]))([ Halogen_HTML_Core.text(t) ]);
                                  };
                              };
                          };
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("flex pv3") ])([ arrowButton(ToggleYear.create(Prev.value))("<<")(new Data_Maybe.Just("ml2")), arrowButton(ToggleMonth.create(Prev.value))("<")(Data_Maybe.Nothing.value), dateHeader, arrowButton(ToggleMonth.create(Next.value))(">")(Data_Maybe.Nothing.value), arrowButton(ToggleYear.create(Next.value))(">>")(new Data_Maybe.Just("mr2")) ]);
                      })();
                      var calendarHeader = (function () {
                          var headers = [ "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" ];
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("flex pv3") ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(headers)(function (day) {
                              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("w3") ])([ Halogen_HTML_Core.text(day) ]);
                          }));
                      })();
                      var renderCalendar = Halogen_HTML_Elements.div(Select_Primitives_Container.getContainerProps([ Halogen_HTML_Properties.class_("tc"), Halogen_HTML_CSS.style(CSS_Geometry.width(CSS_Size.rem(28.0))) ]))([ calendarNav, calendarHeader, Halogen_HTML_Elements.div_(renderRows(Docs_Components_Calendar_Utils.rowsFromArray(cst.items))) ]);
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mw8 sans-serif center") ])([ renderToggle, Halogen_HTML.slot(Data_Unit.unit)(Select_Primitives_Container.component(dictMonadAff))({
      ...
      var initialState = Data_Function["const"]({
          targetDate: new Data_Tuple.Tuple(Docs_Components_Calendar_Utils.unsafeMkYear(2019), Docs_Components_Calendar_Utils.unsafeMkMonth(2))
      });
      var $$eval = function (v) {
          ...
          if (v instanceof HandleContainer) {
              ...
              if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                      var showCalendar = function (v1) {
                          return Data_Show.show(Data_Date.showDate)(v1.value3);
                      };
                      return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.log("Selected! Choice was " + showCalendar(v.value0.value0)));
                  })());
              };
              throw new Error("Failed pattern match at Docs.Components.Calendar line 80, column 30 - line 85, column 73: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof ToggleMonth) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  var newDate = (function () {
                      if (v.value0 instanceof Next) {
                          return Docs_Components_Calendar_Utils.nextMonth(Data_Date.canonicalDate(y)(m)(Data_Bounded.bottom(Data_Date_Component.boundedDay)));
                      };
                      if (v.value0 instanceof Prev) {
                          return Docs_Components_Calendar_Utils.prevMonth(Data_Date.canonicalDate(y)(m)(Data_Bounded.bottom(Data_Date_Component.boundedDay)));
                      };
                      throw new Error("Failed pattern match at Docs.Components.Calendar line 93, column 23 - line 95, column 60: " + [ v.value0.constructor.name ]);
                  })();
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $65.targetDate = new Data_Tuple.Tuple(Data_Date.year(newDate), Data_Date.month(newDate));
                      return $65;
                  });
              }));
          };
          if (v instanceof ToggleYear) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  var newDate = (function () {
                      if (v.value0 instanceof Next) {
                          return Docs_Components_Calendar_Utils.nextYear(Data_Date.canonicalDate(y)(m)(Data_Bounded.bottom(Data_Date_Component.boundedDay)));
                      };
                      if (v.value0 instanceof Prev) {
                          return Docs_Components_Calendar_Utils.prevYear(Data_Date.canonicalDate(y)(m)(Data_Bounded.bottom(Data_Date_Component.boundedDay)));
                      };
                      throw new Error("Failed pattern match at Docs.Components.Calendar line 105, column 23 - line 107, column 59: " + [ v.value0.constructor.name ]);
                  })();
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $72 = {};
                      for (var $73 in v2) {
                      ...
                      $72.targetDate = new Data_Tuple.Tuple(Data_Date.year(newDate), Data_Date.month(newDate));
                      return $72;
                  });
              }));
          };
          if (v instanceof SetTime) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadAff.MonadEff0()))(Control_Monad_Eff_Now.now))(function (v1) {
                  var d = Data_DateTime.date(Data_DateTime_Instant.toDateTime(v1));
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $78.targetDate = new Data_Tuple.Tuple(Data_Date.year(d), Data_Date.month(d));
                      return $78;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          throw new Error("Failed pattern match at Docs.Components.Calendar line 77, column 12 - line 115, column 16: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleParentComponent(Data_Ord.ordUnit)({
          ...
          initializer: new Data_Maybe.Just(Halogen_Query.action(SetTime.create)),
          finalizer: Data_Maybe.Nothing.value
      });
  };
...
})(PS["Docs.Components.Calendar"] = PS["Docs.Components.Calendar"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var testData = [ "Thomas Honeyman", "Dave Zuch", "Chris Cornwell", "Forest Toney", "Lee Leathers", "Kim Wu", "Rachel Blair", "Tara Strauss", "Sanket Sabnis", "Aaron Chu", "Vincent Busam", "Riley Gibbs", "THE COOKIE MONSTER DID NOTHING WRONG" ];
  var class_ = function ($32) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($32));
  };
  var renderContainer = function (st) {
      var renderItems = function (html) {
          return Halogen_HTML_Elements.div(Select_Primitives_Container.getContainerProps([ class_("absolute bg-white shadow rounded-sm pin-t pin-l w-full") ]))([ Halogen_HTML_Elements.ul([ class_("list-reset") ])(html) ]);
      };
      var renderItem = function (index) {
          return function (item) {
              var props = [ class_("px-4 py-1 text-grey-darkest" + (function () {
                  var $9 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(st.highlightedIndex)(new Data_Maybe.Just(index));
                  if ($9) {
                      return " bg-grey-lighter";
                  };
                  return "";
              })()) ];
              return Halogen_HTML_Elements.li(Select_Primitives_Container.getItemProps(index)(props))([ Halogen_HTML_Core.text(item) ]);
          };
      };
  ...
  var renderSelections = function (items) {
      ...
      var $11 = Data_Array.length(items) === 0;
      if ($11) {
  ...
  var renderToggle = function (dictMonadAff) {
      return Halogen_HTML_Elements.div(Select_Primitives_Container.getToggleProps(ToContainer.create)([ Halogen_HTML_Events.onMouseOver(Halogen_HTML_Events.input_(Log.create("I'm the parent."))), class_("rounded-sm bg-white w-full flex py-1 px-1") ]))([ Halogen_HTML_Elements.p([ class_("text-grey-dark py-1 px-3 flex-auto") ])([ Halogen_HTML_Core.text("Select an option") ]), Halogen_HTML_Elements.p([ class_("font-medium text-blue-light border-l ml-1 px-3 text-sm cursor-pointer self-center") ])([ Halogen_HTML_Core.text("Browse") ]) ]);
  };
  var component = function (dictMonadAff) {
      var render = function (st) {
          return Halogen_HTML_Elements.div([ class_("w-full") ])([ renderSelections(st.selected), renderToggle(dictMonadAff), Halogen_HTML.slot(Data_Unit.unit)(Select_Primitives_Container.component(dictMonadAff))({
              items: testData,
      ...
      var $$eval = function (v) {
          if (v instanceof Log) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.log(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
          };
          if (v instanceof ToContainer) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(v.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
          };
          if (v instanceof HandleContainer) {
              ...
              if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.log("Selected: " + v.value0.value0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $19.selected = Data_Array.cons(v.value0.value0)(st.selected);
                          return $19;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.logShow(Data_Show.showArray(Data_Show.showString))(v1.selected)))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitives_Container.ContainerReceiver.create({
                                      render: renderContainer,
                                      items: Data_Array.difference(Data_Eq.eqString)(v1.items)(v1.selected)
                                  }))))(function (v2) {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
              ...
              throw new Error("Failed pattern match at Docs.Components.Dropdown line 80, column 30 - line 94, column 17: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof Removed) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var newSelections = Data_Array["delete"](Data_Eq.eqString)(v.value0)(v1.selected);
                  var newItems = Data_Array.difference(Data_Eq.eqString)(newSelections)(v1.items);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $27 = {};
                      for (var $28 in v2) {
          ...
          throw new Error("Failed pattern match at Docs.Components.Dropdown line 75, column 12 - line 109, column 15: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
          initialState: Data_Function["const"](initState),
          render: render,
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
...
(function(exports) {
  ...
  var filterItems = function (str) {
      return Data_Array.filter(function (i) {
          return Data_String.contains(str)(i);
      });
  };
  var class_ = function ($50) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($50));
  };
  var renderContainer = function (st) {
      var renderItems = function (html) {
          return Halogen_HTML_Elements.div(Select_Primitives_Container.getContainerProps([ class_("absolute bg-white shadow rounded-sm pin-t pin-l w-full") ]))([ Halogen_HTML_Elements.ul([ class_("list-reset") ])(html) ]);
      ...
      var renderItem = function (index) {
          return function (item) {
              var props = [ class_("px-4 py-1 text-grey-darkest" + (function () {
                  var $16 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(st.highlightedIndex)(new Data_Maybe.Just(index));
                  if ($16) {
                      return " bg-grey-lighter";
                  };
                  return "";
  ...
  var renderSearch = function (v) {
      return Halogen_HTML_Elements.input(Select_Primitives_Search.getInputProps([ class_("rounded-sm bg-white w-full flex py-2 px-3"), Halogen_HTML_Properties.placeholder("Type to search...") ]));
  };
  var renderSelections = function (items) {
      var closeButton = function (item) {
          return Halogen_HTML_Elements.span([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Removed.create(item))), class_("absolute pin-t pin-b pin-r p-1 mx-3 cursor-pointer") ])([ Halogen_HTML_Core.text("\xd7") ]);
      ...
      var $18 = Data_Foldable.length(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(items) === 0;
      if ($18) {
          return Halogen_HTML_Elements.div_([  ]);
      };
      return Halogen_HTML_Elements.div([ class_("bg-white rounded-sm w-full border-b border-grey-lighter") ])([ Halogen_HTML_Elements.ul([ class_("list-reset") ])(Data_Functor.map(Data_Functor.functorArray)(renderSelectedItem)(items)) ]);
  ...
  var component = function (dictMonadAff) {
      var render = function (st) {
          return Halogen_HTML_Elements.div([ class_("w-full") ])([ renderSelections(st.selected), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Select_Primitives_Search.component(dictMonadAff))({
              render: renderSearch,
              search: Data_Maybe.Nothing.value,
              debounceTime: 300.0
          })(Halogen_HTML_Events.input(HandleSearch.create)), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Select_Primitives_Container.component(dictMonadAff))({
              render: renderContainer,
              items: st.items
          })(Halogen_HTML_Events.input(HandleContainer.create)) ]);
      };
      ...
      var $$eval = function (v) {
          if (v instanceof Log) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.log(v.value0)));
          };
          if (v instanceof HandleSearch) {
              if (v.value0 instanceof Select_Primitives_Search.ContainerQuery) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(v.value0.value0))(function (v1) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              ...
              if (v.value0 instanceof Select_Primitives_Search.NewSearch) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.log("New search performed: " + v.value0.value0)))(function () {
                          var filtered = filterItems(v.value0.value0)(v1.items);
                          var available = Data_Array.difference(Data_Eq.eqString)(filtered)(v1.selected);
                          var newItems = (function () {
                              if (Data_Foldable.length(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(available) < 1) {
                                  return Data_Array.cons(v.value0.value0)(available);
                              };
                              if (Data_Boolean.otherwise) {
                                  return available;
                              };
                              throw new Error("Failed pattern match at Docs.Components.Typeahead line 103, column 15 - line 105, column 51: " + [  ]);
                          })();
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Halogen_Query.action(Select_Primitives_Container.ContainerReceiver.create({
                              render: renderContainer,
                              items: newItems
                          }))))(function (v2) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadAff.MonadEff0()))(Control_Monad_Eff_Timer.setTimeout(100)(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))))(function (v3) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                          });
                      });
              ...
              throw new Error("Failed pattern match at Docs.Components.Typeahead line 86, column 27 - line 113, column 17: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof HandleContainer) {
              if (v.value0 instanceof Select_Primitives_Container.Emit) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)($$eval(v.value0.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              ...
              if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $32 = Data_Foldable.length(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(Data_Array.filter(Data_Eq.eq(Data_Eq.eqString)(v.value0.value0))(v1.items)) > 0;
                          if ($32) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  var $33 = {};
                                  for (var $34 in v2) {
                                  ...
                                  $33.selected = Data_Array.cons(v.value0.value0)(v1.selected);
                                  return $33;
                              });
                          };
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $36.items = Data_Array.cons(v.value0.value0)(v1.items);
                              $36.selected = Data_Array.cons(v.value0.value0)(v1.selected);
                              return $36;
                          });
                      })())(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Halogen_Query.action(Select_Primitives_Container.ContainerReceiver.create({
                                  render: renderContainer,
                                  items: Data_Array.difference(Data_Eq.eqString)(v2.items)(v2.selected)
                              }))))(function (v3) {
                                  return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Apply.applySecond(Control_Monad_Aff.applyAff)(Control_Monad_Aff_Console.log("List of selections..."))(Control_Monad_Aff_Console.logShow(Data_Show.showArray(Data_Show.showString))(v2.selected)));
                              });
                          });
                      });
                  }));
              };
              throw new Error("Failed pattern match at Docs.Components.Typeahead line 116, column 30 - line 134, column 76: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof Removed) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $44.selected = Data_Array.filter(Data_Eq.notEq(Data_Eq.eqString)(v.value0))(v1.selected);
                      return $44;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Halogen_Query.action(Select_Primitives_Container.ContainerReceiver.create({
          ...
          throw new Error("Failed pattern match at Docs.Components.Typeahead line 82, column 12 - line 147, column 74: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Data_Void = PS["Data.Void"];
  var Docs_Components_Calendar = PS["Docs.Components.Calendar"];
  ...
  var typeahead = function (dictMonadAff) {
      var render = function (v) {
          return Halogen_HTML.slot(Data_Unit.unit)(Docs_Components_Typeahead.component(dictMonadAff))([ "Lyndsey Duffield", "Chris Pine", "Kevin Hart" ])(Data_Function["const"](Data_Maybe.Nothing.value));
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
  ...
  var dropdown = function (dictMonadAff) {
      var render = function (v) {
          return Halogen_HTML.slot(Data_Unit.unit)(Docs_Components_Dropdown.component(dictMonadAff))(Data_Unit.unit)(Data_Void.absurd);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
  ...
  var calendar = function (dictMonadAff) {
      var render = function (v) {
          return Halogen_HTML.slot(Data_Unit.unit)(Docs_Components_Calendar.component(dictMonadAff))(Data_Unit.unit)(Data_Void.absurd);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
...
})(PS["Docs.App.Component"] = PS["Docs.App.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Category = PS["Control.Category"];
  ...
  exports["proxy"] = proxy;
})(PS["Docs.App.Proxy"] = PS["Docs.App.Proxy"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Data_Void = PS["Data.Void"];
  var Docs_App_Component = PS["Docs.App.Component"];
  var Docs_App_Proxy = PS["Docs.App.Proxy"];
  var Halogen = PS["Halogen"];
  ...
  var selectElements = function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Bind.bindFlipped(Control_Monad_Eff.bindEff)(Control_Bind.composeKleisliFlipped(Control_Monad_Eff.bindEff)(function ($25) {
          return DOM_Node_ParentNode.querySelectorAll(v.query)(DOM_HTML_Types.htmlDocumentToParentNode($25));
      })(DOM_HTML_Window.document))(DOM_HTML.window)))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(DOM_Node_NodeList.toArray(v1)))(function (v2) {
              var elems = Data_Maybe.fromMaybe([  ])(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Functor.map(Data_Functor.functorArray)(function ($26) {
                  return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Control_Monad_Except.runExcept(DOM_HTML_Types.readHTMLElement(Data_Foreign.toForeign($26))));
              })(v2)));
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(DOM_Classy_Element.getAttribute(DOM_Classy_Element.isElementHTMLElement)(v.attr))(elems)))(function (v3) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Array.zipWith(function (v4) {
                      return function (v5) {
                          return {
                              element: v4,
                              attr: v5
                  ...
                  })(elems)(Data_Functor.map(Data_Functor.functorArray)(Data_Maybe.fromMaybe(""))(v3)));
              });
          });
      });
  };
  var routes = function (dictMonadAff) {
      return Data_Map.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ Data_Tuple.Tuple.create("dropdown")(Docs_App_Proxy.proxy(Docs_App_Component.dropdown(dictMonadAff))), Data_Tuple.Tuple.create("typeahead")(Docs_App_Proxy.proxy(Docs_App_Component.typeahead(dictMonadAff))), Data_Tuple.Tuple.create("calendar")(Docs_App_Proxy.proxy(Docs_App_Component.calendar(dictMonadAff))) ]);
  };
  var awaitSelectAll = function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(selectElements(v))(Control_Applicative.pure(Control_Monad_Aff.applicativeAff));
      });
  };
  var app = function (dictMonadAff) {
      var render = function (st) {
          var mbComponent = Data_Map.lookup(Data_Ord.ordString)(st)(routes(dictMonadAff));
          ...
          throw new Error("Failed pattern match at Main line 69, column 7 - line 71, column 61: " + [ mbComponent.constructor.name ]);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(awaitSelectAll({
      query: "div[data-component-id]",
      attr: "data-component-id"
  }))(function (v) {
      return Data_Function.flip(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray))(v)(function (e) {
          return Halogen_VDom_Driver.runUI(app(Control_Monad_Aff_Class.monadAffAff))(e.attr)(e.element);
      });
  }));
  exports["main"] = main;
