      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Highlight) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                      ...
                      throw new Error("Failed pattern match at Select line 181, column 55 - line 188, column 70: " + [ v.value0.constructor.name ]);
                  })());
              });
          };
          ...
          if (v instanceof ToggleVisibility) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Select line 238, column 9 - line 240, column 44: " + [ v1.value1.visibility.constructor.name ]);
              }));
          };
          ...
          throw new Error("Failed pattern match at Select line 143, column 12 - line 256, column 46: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var setToggleProps = Data_Function.flip(Data_Semigroup.append(Data_Semigroup.semigroupArray))([ Halogen_HTML_Events.onFocus(Halogen_HTML_Events.input(function (ev) {
      return function (a) {
  ...
  })), Halogen_HTML_Events.onMouseDown(Halogen_HTML_Events.input(function (ev) {
      return function (a) {
          return Select.andThen(Select.andThen(Select.andThen(Halogen_Query.action(Select.CaptureRef.create(DOM_Event_Types.mouseEventToEvent(ev))))(Halogen_Query.action(Select.PreventClick.create(ev))))(Halogen_Query.action(Select.TriggerFocus.create)))(new Select.ToggleVisibility(a));
      };
  })), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(Select.Key.create)), Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_(Select.SetVisibility.create(Select.Off.value))), Halogen_HTML_Properties.tabIndex(0) ]);
      ...
      var render = function (st) {
          ...
          var renderDropdown = function (state) {
              var renderToggle = (function () {
                  var props = [ class_("bg-blue hover:bg-blue-dark text-white font-bold py-2 px-4 rounded-sm w-full flex") ];
                  return Halogen_HTML_Elements.button(Select_Utils_Setters.setToggleProps(props))([ Halogen_HTML_Core.text(st.text) ]);
              })();
              var renderContainer = (function () {
                  var renderItems = function (html) {
                      var props = [ class_("absolute bg-white shadow rounded-sm pin-t pin-l w-full") ];
                      return Halogen_HTML_Elements.div(Select_Utils_Setters.setContainerProps(props))([ Halogen_HTML_Elements.ul([ class_("list-reset") ])(html) ]);
                  };
              ...
              return Halogen_HTML_Elements.div_([ renderToggle, renderContainer ]);
          };
          var input = {
          ...
          return Halogen_HTML_Elements.div([ class_("w-full") ])([ Halogen_HTML.slot(Data_Unit.unit)(Select.component(dictMonadAff))(input)(Halogen_HTML_Events.input(HandleSelect.create)) ]);
      };
      var initialState = function (i) {
          return {
              items: i.items,
      ...
      var $$eval = function (v) {
          if (v.value0 instanceof Select.Selected) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select.SetVisibility.create(Select.Off.value))))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select.ReplaceItems.create(Data_Array.difference(Data_Eq.eqString)(v1.items)([ v.value0.value0 ])))))(function (v3) {
...
(function(exports) {
  ...
  var renderInputContainer = function (state) {
      var renderInput = Halogen_HTML_Elements.input(Select_Utils_Setters.setInputProps([ class_("rounded-sm bg-white w-full flex py-2 px-3"), Halogen_HTML_Properties.placeholder("Type to search...") ]));
      var renderContainer = (function () {
          var renderItem = function (index) {
              return function (item) {
                  var props = [ class_("px-4 py-1 text-grey-darkest" + (function () {
          ...
          var renderChild = Halogen_HTML_Elements.div([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Select.Raise.create(Halogen_Query.action(Log.create("I was clicked"))))) ])([ Halogen_HTML_Core.text("CLICK ME I'M FROM THE PARENT") ]);
          var renderItems = function (html) {
  ...
  var component = function (dictMonadAff) {
      ...
      var $$eval = function (v) {
              ...
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                  ...
                  if (v.value0 instanceof Select.Searched) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select.ReplaceItems.create(newItems))))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(function ($46) {
                                  return Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select.Highlight.create(Select.Index.create($46))));
                              })(index))(function () {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v3) {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select.ReplaceItems.create(newItems))))(function (v4) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select.ReplaceItems.create(newItems))))(function (v3) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
                  });
          ...
          throw new Error("Failed pattern match at Docs.Components.Typeahead line 76, column 12 - line 119, column 15: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
          initialState: initialState,
          render: render,
...
(function(exports) {
  ...
  var routes = function (dictMonadAff) {
      return Data_Map.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ Data_Tuple.Tuple.create("typeahead")(Docs_App_Proxy.proxy(Docs_App_Component.typeahead(dictMonadAff))), Data_Tuple.Tuple.create("dropdown")(Docs_App_Proxy.proxy(Docs_App_Component.dropdown(dictMonadAff))) ]);
  };
  ...
  var app = function (dictMonadAff) {
      var render = function (st) {
          ...
          throw new Error("Failed pattern match at Main line 67, column 7 - line 69, column 61: " + [ mbComponent.constructor.name ]);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
