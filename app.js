...
(function(exports) {
  ...
  var component = function (dictMonadAff) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof ToggleMonth) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  var newDate = (function () {
                      ...
                      throw new Error("Failed pattern match at Docs.Components.Calendar line 95, column 23 - line 97, column 60: " + [ v.value0.constructor.name ]);
                  })();
          ...
          if (v instanceof ToggleYear) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  var newDate = (function () {
                      ...
                      throw new Error("Failed pattern match at Docs.Components.Calendar line 107, column 23 - line 109, column 59: " + [ v.value0.constructor.name ]);
                  })();
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $72 = {};
                      for (var $73 in v2) {
          ...
          throw new Error("Failed pattern match at Docs.Components.Calendar line 77, column 12 - line 117, column 16: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var class_ = function ($34) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($34));
  };
      ...
      var renderItem = function (index) {
          return function (item) {
              var props = [ class_("px-4 py-1 text-grey-darkest" + (function () {
                  var $10 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(st.highlightedIndex)(new Data_Maybe.Just(index));
                  if ($10) {
  ...
  var renderSelections = function (v) {
      ...
      if (v instanceof Data_Maybe.Just) {
          return Halogen_HTML_Elements.div([ class_("bg-white rounded-sm w-full border-b border-grey-lighter") ])([ Halogen_HTML_Elements.ul([ class_("list-reset") ])([ Halogen_HTML_Elements.li([ class_("px-4 py-1 text-grey-darkest hover:bg-grey-lighter relative") ])([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(v.value0) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Removed.create(v.value0))), class_("absolute pin-t pin-b pin-r p-1 mx-3 cursor-pointer") ])([ Halogen_HTML_Core.text("\xd7") ]) ]) ]) ]);
      };
      throw new Error("Failed pattern match at Docs.Components.Dropdown line 194, column 1 - line 197, column 20: " + [ v.constructor.name ]);
  };
              ...
              if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.log("Selected: " + v.value0.value0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $21.selected = Control_Applicative.pure(Data_Maybe.applicativeMaybe)(v.value0.value0);
                          return $21;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.logShow(Data_Maybe.showMaybe(Data_Show.showString))(v1.selected)))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitives_Container.SetVisibility.create(Select_Primitives_Container.Off.value))))(function (v2) {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                          });
          ...
          if (v instanceof Removed) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $29.selected = Data_Maybe.Nothing.value;
                      return $29;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitives_Container.ReplaceItems.create(v1.items))))(function (v2) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Docs.Components.Dropdown line 75, column 12 - line 104, column 15: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var renderContainer = function (st) {
      ...
      var renderItem = function (index) {
          return function (item) {
              var props = [ class_("px-4 py-1 text-grey-darkest" + (function () {
                  var $14 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(st.highlightedIndex)(new Data_Maybe.Just(index));
                  if ($14) {
                      return " bg-grey-lighter";
                  };
                  return "";
  ...
  var renderSelections = function (items) {
      ...
      var $16 = Data_Foldable.length(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(items) === 0;
      if ($16) {
          return Halogen_HTML_Elements.div_([  ]);
      };
  ...
  var component = function (dictMonadAff) {
          ...
          var searchContainerInput = {
              ...
              render: function (search) {
                  return function (container) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("flex-auto") ])([ search, container ]);
                  };
              }
          };
          return Halogen_HTML_Elements.div([ class_("w-full") ])([ renderSelections(st.selected), Halogen_HTML.slot(Data_Unit.unit)(Select_Primitives_SearchContainer.component(dictMonadAff))(searchContainerInput)(Halogen_HTML_Events.input(HandleSearchContainer.create)) ]);
      };
      var initialState = function (i) {
          return {
              items: i,
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleSearchContainer) {
              ...
              if (v.value0 instanceof Select_Primitives_SearchContainer.SearchMessage) {
                  if (v.value0.value0 instanceof Select_Primitives_Search.NewSearch) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          var filtered = filterItems(v.value0.value0.value0)(v1.items);
                          var available = Data_Array.difference(Data_Eq.eqString)(filtered)(v1.selected);
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select_Primitives_SearchContainer.inContainer(Select_Primitives_Container.ReplaceItems.create(available))))(function (v2) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
                  };
                  ...
                  if (v.value0.value0 instanceof Select_Primitives_Container.ItemSelected) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              var $28 = Data_Foldable.length(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(Data_Array.filter(Data_Eq.eq(Data_Eq.eqString)(v.value0.value0.value0))(v1.items)) > 0;
                              if ($28) {
                                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                      var $29 = {};
                                      for (var $30 in v2) {
                                      ...
                                      $29.selected = Data_Array.cons(v.value0.value0.value0)(v1.selected);
                                      return $29;
                                  });
                              };
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  $32.items = Data_Array.cons(v.value0.value0.value0)(v1.items);
                                  $32.selected = Data_Array.cons(v.value0.value0.value0)(v1.selected);
                                  return $32;
                              });
                          })())(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select_Primitives_SearchContainer.inContainer(Select_Primitives_Container.ReplaceItems.create(newItems))))(function (v3) {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                          });
              ...
              throw new Error("Failed pattern match at Docs.Components.Typeahead line 85, column 36 - line 112, column 30: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof Removed) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $41.selected = Data_Array.filter(Data_Eq.notEq(Data_Eq.eqString)(v.value0))(v1.selected);
                      return $41;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          var newItems = Data_Array.difference(Data_Eq.eqString)(v2.items)(v2.selected);
          ...
          throw new Error("Failed pattern match at Docs.Components.Typeahead line 81, column 12 - line 122, column 15: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
          initialState: initialState,
          render: render,
...
(function(exports) {
  ...
  var typeahead = function (dictMonadAff) {
      ...
      var render = function (v) {
          return Halogen_HTML.slot(Data_Unit.unit)(Docs_Components_Typeahead.component(dictMonadAff))(users)(Data_Function["const"](Data_Maybe.Nothing.value));
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
